...
wget -q --show-progress -O $tmpDir/geckodriver.tar.gz "https://github.com/mozilla/geckodriver/releases/download/${firefoxVersion}/geckodriver-${firefoxVersion}-macos.tar.gz"
...
wget -q --show-progress -O $tmpDir/chromedriver.zip "https://chromedriver.storage.googleapis.com/${chromeVersion}/chromedriver_mac64.zip"
